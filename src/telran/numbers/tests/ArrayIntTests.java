...
class ArrayIntTests {
	...
	void addNumberTest() {
		...
		int ar[] = { 1, 2, -10 };
		// assertTrue(expected == ArrayInt.addNumber(ar, 20)); - wrong test as the
	...
	void binarySearchTest() {
		...
		int ar2[] = { 1, 1, 5, 5, 100, 100, 600, 600, 600, 600, 780, 1230, 6590, 6590, 6590, 6590 };
		assertEquals(6, ArrayInt.binaryIndexOf(ar2, 600));
		assertEquals(12, ArrayInt.binaryIndexOf(ar2, 6590));
		assertEquals(-17, ArrayInt.binaryIndexOf(ar2, 7999));
		assertEquals(-3, ArrayInt.binaryIndexOf(ar2, 4));
